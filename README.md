...
>
> **想搞清这个项目的定位(以及和 VLA 的关系)?** 读 [docs/POSITIONING.md](docs/POSITIONING.md) —— 这是一个"任务级编排 + 安全运行时",VLA 是未来挂在它下面的一类 learned skill;附[恢复职责矩阵 docs/RECOVERY_OWNERSHIP.md](docs/RECOVERY_OWNERSHIP.md)(哪一层负责哪种恢复,由 Phase C 实测撞出)。
...
| **项目定位 + 与 VLA 的关系 + 恢复职责矩阵** | [docs/POSITIONING.md](docs/POSITIONING.md), [docs/RECOVERY_OWNERSHIP.md](docs/RECOVERY_OWNERSHIP.md) |
